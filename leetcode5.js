...
/**
 ...
 approach: the key to finding a palindromic substring is to look for it from the center to the ends
 ...
 从中心向两边膨胀,设置终止条件
 expand from the center and set a termination condition
 终止时如果当前为最长子串,则记录指针位置
 save the two pointers at the end of the loop if the current substring is the longest
 所以这就是全部代码
